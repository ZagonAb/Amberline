...
FocusableItem {
    ...
    Item {
        ...
        ColorOverlay {
            anchors.fill: systemArt
            source: systemArt
            color: Style.currentThemeName === "light" ? "#0a0a0a" : "white"
            visible: systemArt.source !== "" && systemArt.status === Image.Ready
        }
    }
    ...
    Item {
        ...
        property bool showReflection: root.isCurrent && (art.visible || systemArtContainer.visible)
    ...
    ShaderEffect {
        ...
        visible: root.isCurrent && (art.visible || systemArtContainer.visible)
    ...
    Text {
        ...
        visible: !art.visible && !systemArtContainer.visible
    }
